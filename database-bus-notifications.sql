-- =============================================
-- BUS NOTIFICATION SYSTEM DATABASE SCHEMA
-- =============================================
...
-- =============================================
CREATE INDEX IF NOT EXISTS idx_bus_notifications_user_id ON bus_notifications(user_id);
CREATE INDEX IF NOT EXISTS idx_bus_notifications_bus_schedule_id ON bus_notifications(bus_schedule_id);
CREATE INDEX IF NOT EXISTS idx_bus_notifications_active ON bus_notifications(is_active) WHERE is_active = TRUE;
CREATE INDEX IF NOT EXISTS idx_bus_notifications_pending ON bus_notifications(notification_time) WHERE is_sent = FALSE AND is_active = TRUE;
...
CREATE TRIGGER update_bus_notifications_updated_at BEFORE UPDATE ON bus_notifications FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
