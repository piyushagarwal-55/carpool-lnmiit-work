-- CORRECTED VERSION - Uses actual table names from the database
-- Fixes the "ride_bookings does not exist" error
...
-- Function 1: Hard delete with complete cleanup (CORRECTED TABLE NAMES)
...
BEGIN
    ...
    -- Delete related records with error handling (USING CORRECT TABLE NAMES)
    BEGIN
        ...
        -- Delete ride passengers (NOT ride_bookings!)
        DELETE FROM ride_passengers 
        WHERE ride_id::TEXT = ride_id_param;
        
        -- Delete notifications related to this ride
...
-- Function 2: Soft delete (cancel) with reason (CORRECTED TABLE NAMES)
